...
questions_routes.add_url_rule('/question/create/', view_func=CreateQuestionView.as_view('create_question'))
questions_routes.add_url_rule('/question/<int:question_id>/', view_func=QuestionView.as_view('question'))
